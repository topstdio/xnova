...
if ($_GET['mode'] == 'ainfo') {
	...
	if ($ally_description != "") {
		...
		$ally_description = "<tr><th colspan=2 height=100>".$lang['NoDescript']."</th></tr>";
	...
	if ($user['ally_id'] == 0) {
		$lang['bewerbung'] = "<tr>
	  <th>".$lang['write_apply']."</th>
	  <th><a href=\"alliance.php?mode=apply&amp;allyid=" . $id . "\">".$lang['Send_Apply']."</a></th>
