...
//					$_POST['text'] = str_replace('\r\n', '<br />', $_POST['text']);
		...
		case 'show':
			...
			$page .= "new_win.focus();\n";
			$page .= "}\n";
			$page .= "function cc(){var oC=document.getElementsByTagName('input');if(oC){for(var i=0;i <oC.length;i++){if(oC(i).type=='checkbox')oC(i).checked=!oC(i).checked;}}}\n";
			$page .= "</script>\n";
			$page .= "<table width=\"75%\">";
			$page .= "<form action=\"messages.php\" method=\"post\">";
			...
			$page .= "</tr><tr>";
			$page .= "<th><a href='javascript:void(0);' onclick='cc()'>".$lang['mess_action']."</a></th>";
			...
			if ($MessCategory == 100) {
				...
				while ($CurMess = mysql_fetch_array($UsrMess)) {
					...
					$page .= "<th>". date("Y-m-d H:i:s", $CurMess['message_time']) ."</th>";
