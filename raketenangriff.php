...
if ($error == 1) {
	message('导致错误可能的原因有：导弹数量不够或目标星球不存在或攻击目标选择错误！', '错误');
	exit();
}
...
$def =array(
		...
		1 => $planet['small_laser'], // Leichtes Lasergesch黷z
		2 => $planet['big_laser'], // Schweres Lasergesch黷z
		3 => $planet['gauss_canyon'], // Gau遦anone
		4 => $planet['ionic_canyon'], // Ionengesch黷z
		5 => $planet['buster_canyon'], // Plasmawerfer
		6 => $planet['small_protection_shield'], // Kleine Schildkuppel
		7 => $planet['big_protection_shield'], // Gro遝 Schildkuppel
  ...
  <tbody><tr>
    <td>
      <table>
        <tbody>
        <tr>
         <td class="c" colspan="1">导弹星际攻击</td>
	</tr>
        <tr>
	<td class="l"><?php echo "<b>".$anz."</b> 个星际导弹发射成功!"; ?>
        </tr>
       </tbody></table>
      </td>
      </tr>
